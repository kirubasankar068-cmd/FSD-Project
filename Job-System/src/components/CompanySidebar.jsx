...
export default function CompanySidebar({ user, isPremium, onLogout, onClose, collapsed, onToggle, isMobileOpen }) {
  ...
  const menuItems = [
    { id: 'pipeline', icon: TrendingUp, label: 'Talent Pipeline', path: '/company-dashboard?tab=pipeline' },
    { id: 'candidates', icon: Users, label: 'Candidate Pool', path: '/candidates' },
    { id: 'vacancies', icon: Search, label: 'Active Vacancies', path: '/company-dashboard?tab=vacancies' },
    { id: 'billing', icon: Bookmark, label: 'Financial Hub', path: '/company-dashboard?tab=billing' },
    { id: 'details', icon: Building2, label: 'Company Profile', path: '/company-dashboard?tab=details' },
  ];

  const secondaryItems = [
    { id: 'messages', icon: Mail, label: 'Direct Messages', path: '/messages', badge: unreadMessages },
    { id: 'notifications', icon: Bell, label: 'Alerts', path: '/notifications', dot: hasNotifications },
    { id: 'resources', icon: BookOpen, label: 'Market Resources', path: '/resources' },
  ];
